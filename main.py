...
def AddBaseAdmin():
    ...
    houses = [GuestHouse(id=0, address="hyderabad", description="Resort 1"),
                GuestHouse(id=1, address="kolkota", description="Resort 2"),
                GuestHouse(id=2, address="kochi", description="Resort 3")]
    ...
    amenities = [Amenities(id=0,pricePerDay=0, type="none"),
                ...
                Amenities(id=5, pricePerDay=2000,type="Adventure Park"),
